...
RES.4 <- Lag.Value.4(20, 1000, n = 1000)
```
```{r VISUALIZE Lag}
plot(x = RES.2$lag.years, y = RES.2$LCOE, pch = 19, type = 'b', xlim = c(0,15), ylim = c(65,90),
     xlab = "Years of development", ylab = "LCOE [EUR/MWh]",
     las = 1, xaxs = 'i', yaxs = 'i')
polygon(x = c(2,4,4,2), y = c(0,0,100,100), col = rgb(255/255,128/255,0,0.3), border = FALSE) #typical construction time
polygon(x = c(5,12,12,5), y = c(0,0,100,100), col = rgb(0/255,153/255,0,0.3), border = FALSE) #typical deployment time
```
...
Result.high <- Calc.Topologies(LAG = 15)
