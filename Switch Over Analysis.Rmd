...
Calc.Topologies <- function(PLANT = 1000, EL.P = 33, CF = 0.5, CURT = 0.05, PEM.P = 1519000, SHIP.P = 43000000, PIPE.P = 615, PEM.EFF = 0.642, DISC = 0.052, LAG = 3, CF.T = 2, CEF = 0.03) {
...
png(filename = "C:/Users/Rudolph/Desktop/Rudolph/0 - CMU - Portugal PhD Files/0 - Research/Transmission Switch Over/Energy Policy Manuscript/Figure6.png", width = 2100, height = 1200, res = 300)
par(mar = c(5,12,1,1))
