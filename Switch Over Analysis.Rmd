...
# Create a dataframe
df <- data.frame(
  Parameter = c("Discount Rate [%]", "Years of lag [years]","Distance to shore [km]","Electricity cost [€/MWh]","Project Size [MW]"),
  Low_Input = c(-10.48,-6.97,-1.7,-5.54,0.01),
  Low_Input_Label = c(55,59,64,60,66),
  High_Input = c(21.12,7.98,5.99,1.07,-1.19),
  High_Input_Label = c(87,74,72,67,65)
)
...
# Create tornado plot
png(filename = "C:/Users/Rudolph/Desktop/Rudolph/0 - CMU - Portugal PhD Files/0 - Research/Transmission Switch Over/Energy Policy Manuscript/Figure7final.png", width = 2100, height = 1200, res = 300)
...
ggplot(df_long, aes(x = Impact, y = Parameter, fill = Fill, 
  ...
  annotate("text", x = -0.4, y = 5.5, label = "Baseline LCOE", size = 4, hjust = 1, color = "darkred") +
  annotate("text", x = 0.4, y = 5.5, label = "= 65.8 €/MWh", size = 4, hjust = 0, color = "darkred") +
  theme_minimal() +
