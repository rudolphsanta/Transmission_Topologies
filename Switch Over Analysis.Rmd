...
Topology_B <- function(dist.km, plant.MW, cf = 0.5, EL.price = 35, PEM.price = 1926000, PIPE.price = 615, r = 0.052, life = 25, lag = 3, CF.type = 2) { #Follows Van Wingerden et al. (2023)
...
Topology_C <- function(dist.km, plant.MW, cf = 0.5, EL.price = 35, PEM.price = 1926000, SHIP.price = 43000000, r = 0.052, life = 25, lag = 3, CF.type = 2) { 
...
```{r VISUALIZE Lag}
plot(x = RES.2$lag.years, y = RES.2$LCOE, pch = 19, type = 'b', xlim = c(0,15), ylim = c(50,80),
...
Result.high <- Calc.Topologies(LAG = 5, CURT = 0.3)
